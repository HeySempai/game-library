...
export default function GameCard({ game, allGames, expansions, category, onClick }) {
  ...
  return (
    ...
    >
      <div className="bg-[#f2f3f5] rounded-xl sm:rounded-2xl p-3 sm:p-4 pb-3 sm:pb-4 transition-all duration-300 border border-transparent group-hover:bg-[#e8e9ec] group-hover:border-[rgba(57,255,120,0.35)] group-hover:shadow-[0_0_18px_rgba(57,255,120,0.18),0_0_40px_rgba(0,255,136,0.08),inset_0_0_20px_rgba(57,255,120,0.04)]">
        {/* Image container */}
