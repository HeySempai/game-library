...
import { X, Cake, MapPin, Star, Gamepad2, Trophy, List, LayoutGrid } from "lucide-react";

export default function OwnersPanel({ ownersData, games, victories, onClose }) {
      ...
      <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl" onClick={(e) => e.stopPropagation()}>
        <div className="flex items-center justify-between p-5 border-b border-gray-100">
          ...
          <div className="flex gap-2">
            {owner && (
              <button onClick={() => setSelectedOwner(null)} className="text-sm text-gray-400 hover:text-gray-600 px-2 py-1 cursor-pointer">Volver</button>
            )}
            ...
            {ownersData.map((o) => {
              ...
              return (
                <button key={o.id} onClick={() => setSelectedOwner(o.id)}
                  ...
                  {o.titulo && <p className="text-xs italic text-orange-400 mt-0.5">{o.titulo}</p>}
          ...
          <div className="p-5">
            <div className="flex items-start gap-5 mb-6">
              ...
              <div className="flex-1">
                ...
                {owner.titulo && <p className="text-sm italic text-orange-400 mt-0.5">{owner.titulo}</p>}
